  ...
  return (
    <CanvasOptimizer>
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <Canvas camera={{ position: [0, 0, 10], fov: 60, far: 500 }} gl={{ alpha: true }} dpr={GraphicsConfig.dpr as number}>
          ...
          <pointLight position={[-5, -5, 0]} intensity={4} color="#4ea6ff" distance={20} />
          <pointLight position={[5, -5, 0]} intensity={4} color="#ff6ec7" distance={20} />
